...
public class DlgEscolhaPaciente extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DlgEscolhaPaciente.class.getName());
    private final GerentePaciente gerente;
    private Paciente pacienteEscolhido;
    
    public DlgEscolhaPaciente(java.awt.Frame parent, boolean modal, GerentePaciente gerente) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Escolha um Paciente");
        ...
        jScrollPane2.setViewportBorder(javax.swing.BorderFactory.createTitledBorder("Paciente Selecionado"));
        ...
        btnAdicionar.setText("Escolher Paciente");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        Paciente paciente = this.gerente.get(this.edtCpf.getText());
        
        if(paciente != null){
            this.edtEscolha.setText(paciente.toString());
            this.pacienteEscolhido = paciente;
        }
    }//GEN-LAST:event_btnBuscarActionPerformed

    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        if(this.pacienteEscolhido == null){
            int resposta = JOptionPane.showConfirmDialog(null, "Nenhum Paciente foi escolhido deseja continuar?",
                    "Confirm", 
    ...
    public Paciente getPacienteEscolhido() {
        return this.pacienteEscolhido;
    }
